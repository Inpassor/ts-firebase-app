...
exports.validateAWS4 = (request) => {
    ...
    if (config && config.aws && config.aws.appSync) {
        ...
        return functions_1.AWS4.validateAuthorizationHeader(authorizationHeader, functions_1.AWS4.getAmzDate(request.headers), request.rawBody, config.aws.appSync.accessKeyId, config.aws.appSync.region);
    }
    return false;
};
