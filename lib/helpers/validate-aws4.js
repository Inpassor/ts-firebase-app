...
exports.validateAWS4 = (request) => {
    ...
    if (config && config.aws && config.aws.appSync) {
        ...
        return functions_1.AWS4.validateAuthorizationHeader(authorizationHeader, functions_1.AWS4.getAmzDate(request.headers), (config.aws.appSync.validateBody === undefined || config.aws.appSync.validateBody) ?
