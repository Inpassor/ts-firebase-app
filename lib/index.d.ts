...
//   ../firebase-admin
//   ../express
//   ../express-session/session/session
//   ../firebase-functions

declare module '@inpassor/firebase-app' {
    export * from '@inpassor/firebase-app/component';
...
declare module '@inpassor/firebase-app/component' {
    import { IComponent, ComponentOptions, ExpressRequest, ExpressResponse } from '@inpassor/firebase-app/interfaces';
...
declare module '@inpassor/firebase-app/interfaces' {
    import * as admin from 'firebase-admin';
    import * as express from 'express';
    import * as Session from 'express-session/session/session';
    import { Component } from '@inpassor/firebase-app/component';
    import { Model } from '@inpassor/firebase-app/model';
...
declare module '@inpassor/firebase-app/firebase-app' {
    import * as functions from 'firebase-functions';
    import { AppConfig } from '@inpassor/firebase-app/interfaces';
    export const firebaseApp: (config: AppConfig) => functions.HttpsFunction;
}

declare module '@inpassor/firebase-app/model' {
    import { Data, ExpressRequest, ExpressResponse, Firestore, FirestoreCollectionReference, FirestoreDocumentReference, FirestoreDocumentSnapshot, FirestoreQueryDocumentSnapshot, FirestoreTimestamp, FirestoreWriteResult, FirestoreWhereFilterOp, IModel, ModelOptions, ModelSchema } from '@inpassor/firebase-app/interfaces';
